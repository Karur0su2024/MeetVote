...
<div x-data="votingForm">
    ...
    <div class="flex flex-row place-content-between mb-3 bg-base-200 shadow-sm rounded mt-3">
    ...
    <div>
        @if($loaded)
            <form wire:submit.prevent="submitVote()">
                <x-pages.poll-show.poll-new.section-card title="Time">
                    <x-slot:title>
                    ...
                    <div class="grid grid-flow-row grid-cols-2 gap-2">
                        <template x-for="(timeOption, optionIndex) in form.timeOptions">
                            <x-pages.poll-show.poll-new.option-card
                ...
                </x-pages.poll-show.poll-new.section-card>
                ...
                <div class="mt-4">
                    ...
                    <x-ui.form.textbox-new x-model="form.notes"
                    ...
                    <div class="flex flex-row align-items-center gap-2 mt-3">
