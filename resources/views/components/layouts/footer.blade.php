<footer class="bg-gray-900 text-white py-6 shadow-sm rounded-box">
    <div class="container mx-auto text-center">
        ...
        <div class="flex flex-wrap justify-center items-center gap-2">
            ...
            <div class="dropdown dropdown-top">
                <button class="hover:bg-primary/1 cursor-pointer" tabindex="0">
                    {{ __("ui/navbar.language") }}
                </button>

                <ul class="menu dropdown-content w-60 z-1 rounded-box bg-base-100 shadow-sm text-base-content">
                    <li>
