...
<div class="navbar bg-base-100 shadow-sm px-12">
...
{{--            </div>--}}
            ...
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0" class="menu dropdown-content p-2 shadow bg-base-100 rounded-box w-32">
                    <li><a class="btn btn-sm btn-block btn-ghost justify-start" href="{{ route('changeLanguage', 'en') }}">English</a></li>
                    <li><a class="btn btn-sm btn-block btn-ghost justify-start" href="{{ route('changeLanguage', 'cs') }}">Čeština</a></li>
                </ul>
            </div>
